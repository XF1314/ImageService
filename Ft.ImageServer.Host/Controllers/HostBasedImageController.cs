...
namespace Ft.ImageServer.Host.Controllers
{
    ...
    public class HostBasedImageController : AbpController
    {
        ...
        #region 获取照片 支持从m（MongoDB）,f（文件系统）,w（网络）三种途径获取照片
        /// <summary>
        /// 从MongoDB获取照片信息
        /// </summary>
        ...
        /// <returns></returns>
        [HttpGet("/m/{host}/{id:gridfs}/h-{metahash:metahash}/{width:range(0,5000)}x{height:range(0,5000)}/{quality:range(0,100)}/{options:options}")]
        ...
        /// <param name="quality">照片质量</param>
        /// <returns></returns>
        [HttpGet("/m/{host}/{id:gridfs}/h-{metahash:metahash}/{quality:range(0,100)}")]
        ...
        /// <param name="options">附加选项([tgf]{1,3})</param>
        /// <returns></returns>
        [HttpGet("/m/{host}/{id:gridfs}/h-{metahash:metahash}/{quality:range(0,100)}/{options:options}")]
        ...
        /// <param name="quality">照片质量</param>
        /// <returns></returns>
        [HttpGet("/m/{host}/{id:gridfs}/h-{metahash:metahash}/{quality:range(0,100)}/{width:range(0,5000)}x{height:range(0,5000)}")]
        ...
        /// <param name="options">附加选项([tgf]{1,3})</param>
        /// <returns></returns>
        [HttpGet("/m/{host}/{id:gridfs}/{width:range(0,5000)}x{height:range(0,5000)}/{quality:range(0,100)}/{options:options}")]
        ...
        /// <param name="quality">照片质量</param>
        /// <returns></returns>
        [HttpGet("/m/{host}/{id:gridfs}/{quality:range(0,100)}/{width:range(0,5000)}x{height:range(0,5000)}")]
        ...
        /// <returns></returns>
        [HttpPost("/m/{host}/contentbased")]
        public async Task<Result<MongoDBImageSaveOutput>> SaveImageToMongoDBByContentAsync(string host, ContentBasedImageInput contentBasedImageInput)
        {
        ...
        /// <returns></returns>
        [HttpPost("/m/{host}/uribased")]
        public async Task<Result<MongoDBImageSaveOutput>> SaveImageToMongoDBByUriAsync(string host, UriBasedImageInput uriBasedImageInput)
        {
