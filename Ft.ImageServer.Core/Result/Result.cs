...
namespace Ft.ImageServer.Core.Result
{
    ...
    public class Result : IResult
    {
        ...
        {
            get => string.IsNullOrWhiteSpace(_message) ? Code.DisplayName() : _message;
            set => _message = value;
        }
        ...
        /// 返回异常信息
        /// </summary>
        public static Result<T> FromError<T>( T data, string message, ResultCode code = ResultCode.Fail)
        {
            var result = new Result<T>(code, message);
            result.Data = data;
        ...
        /// 返回新结果
        /// </summary>
        public static Result<T> FromResult<T>(Result result)
        {
        ...
        /// 返回新结果
        /// </summary>
        public static Result<T> FromResult<T>(Result result, T data)
        {
        ...
        /// 返回新结果
        /// </summary>
        public static Result<T> FromResult<T>(Result<T> result)
        {
